...
void Alignment::threshOtsu(Mat &patch,Mat &ref)
{	
	Mat OtsuPatchResult,OtsuRefResult;

	threshold(patch, OtsuRefResult, 150, 255, THRESH_OTSU);
	threshold(ref, OtsuPatchResult, 150, 255, THRESH_OTSU);
}

void Alignment::threshBinary(Mat &patch,Mat &ref)
{	
	Mat BinaryPatchResult,BinaryRefResult;

	threshold(patch, BinaryRefResult, 150, 255, THRESH_BINARY);
	threshold(ref, BinaryPatchResult, 150, 255, THRESH_BINARY);
}

void Alignment::threshBinaryINV(Mat &patch,Mat &ref)
{	
	Mat Binary_INV_PatchResult,Binary_INV_RefResult;

	threshold(patch, Binary_INV_RefResult, 150, 255, THRESH_BINARY_INV);
	threshold(ref, Binary_INV_PatchResult, 150, 255, THRESH_BINARY_INV);
}

void Alignment::threshTrunc(Mat &patch,Mat &ref)
{	
	Mat TruncPatchResult,TruncRefResult;

	threshold(patch, TruncRefResult, 150, 255, THRESH_TRUNC);
	threshold(ref, TruncPatchResult, 150, 255, THRESH_TRUNC);
}

void Alignment::threshToZero(Mat &patch,Mat &ref)
{	
	Mat ToZeroPatchResult,ToZeroRefResult;

	threshold(patch, ToZeroRefResult, 150, 255, THRESH_TOZERO);
	threshold(ref, ToZeroPatchResult, 150, 255, THRESH_TOZERO);
}

void Alignment::threshToZeroINV(Mat &patch,Mat &ref)
{	
	Mat ToZero_INV_PatchResult,ToZero_INV_RefResult;

	threshold(patch, ToZero_INV_RefResult, 150, 255, THRESH_TOZERO_INV);
	threshold(ref, ToZero_INV_PatchResult, 150, 255, THRESH_TOZERO_INV);
}
